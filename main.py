...
password= "Nq1dRuaV"
# source file(dump)
csv_file = "/home/aritra/PycharmProjects/Greenplum_to_Azure/star_experiment.cs"
# odbc Server Details
...
'''# bcp
utils.bcp_bulk_load("star_exper", csv_file, Server, DATABASE, UID, PWD)'''
'''
# batch load
...
bar.start()
while True:
  sql = "SELECT * FROM %s  limit %d offset %d " % (name_of_table, chunk_size, offset)
